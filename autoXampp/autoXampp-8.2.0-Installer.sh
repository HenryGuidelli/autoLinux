...
if [ -e /opt/autoLinux/autoXampp/xampp-linux-installer.run ]; then
	...
	sudo wget -P /opt/autoLinux/autoXampp/ -O xampp-linux-installer.run https://sourceforge.net/projects/xampp/files/XAMPP%20Linux/8.2.0/xampp-linux-x64-8.2.0-0-installer.run
	echo "INSTALLER OK!"
fi
